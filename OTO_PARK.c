...
{	
	...
	int b;
	int c;
	star_otopark.araba[].cikis_saat=a;
	star_otopark.araba.cikis_dakika=b;
	star_otopark.araba.park_ucreti=((star_otopark.araba.cikis_saat*60*60)+(star_otopark.araba.cikis_dakika*60)+(star_otopark.araba.cikis_saniye))-((star_otopark.araba.giris_saat*60*60)+(star_otopark.araba.giris_dakika*60)+(star_otopark.araba.giris_saniye));
}*/
